...
def filter_by_gnomad_af(input_vcf, output_prefix, af_threshold=0.005, cadd_threshold=None, additional_fields=None):
    ...
    cadd_phred_idx = None
    if 'CADD_SV_CADD-SV_PHRED-score' in field_names:
        cadd_phred_idx = field_names.index('CADD_SV_CADD-SV_PHRED-score')
...
def create_summary_table(input_vcf, output_prefix, af_threshold, csq_format, cadd_threshold=None, additional_fields=None):
    ...
    cadd_raw_idx = field_names.index('CADD_SV_CADD-SV_Raw-score') if 'CADD_SV_CADD-SV_Raw-score' in field_names else None
    cadd_phred_idx = field_names.index('CADD_SV_CADD-SV_PHRED-score') if 'CADD_SV_CADD-SV_PHRED-score' in field_names else None
    ...
    with open(output_tsv, 'w') as f:
        ...
        if cadd_raw_idx is not None:
            header.append('CADD_SV_CADD-SV_Raw-score')
        if cadd_phred_idx is not None:
            header.append('CADD_SV_CADD-SV_PHRED-score')
...
## Real Run: python3 sv_filtering.py ../sv_annotations/results/case_GS608_sv.annotated.vcf results/ 0.005 20 'Allele,Consequence,IMPACT,SYMBOL,Gene,CADD_SV_CADD-SV_PHRED-score,CADD_SV_CADD-SV_Raw-score'